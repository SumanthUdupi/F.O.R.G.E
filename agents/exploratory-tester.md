...
description: "What automated tests miss — the unhappy path, a different role, an unspecified boundary. Walking the real journey."
...
**AGT-QAA-005** · specialist · **Adversarial QA** (QAA) · reports to **Chief of Works** · tier `standard`

> What automated tests miss — the unhappy path, a different role, an unspecified boundary.
